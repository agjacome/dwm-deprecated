...
static const Rule rules[] = {
    ...
    { "Codelite",				NULL,			NULL,			8,			False,			0 },
    { "Eclipse",				NULL,			"Eclipse",		8,			True,			0 },
    { "Eclipse",				NULL,			"SDK",			8,			True,			0 },
    { "Eclipse",				NULL,			"agjacome",		8,			False,			0 },
    { "Mysql-workbench-bin",	NULL,			NULL,			8,			False,			0 },
    { NULL,						NULL,			"OpenOffice",	16,			True,			0 },
    { NULL,						NULL,			"LibreOffice",	16,			False,			0 },
    { "Comix",					NULL,			NULL,			16,			False,			0 },
...
static Key keys[] = {
    ...
    { MODKEY|ShiftMaskk,	XK_j,				movestack,			{.i = +1 } },
